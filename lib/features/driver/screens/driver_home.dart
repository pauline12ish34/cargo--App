                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        ...
                        if (context.findAncestorStateOfType<_DriverHomeState>() != null) {
                          context.findAncestorStateOfType<_DriverHomeState>()!._onItemTapped(1);
                        }
                      },
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      ...
                      if (context.findAncestorStateOfType<_DriverHomeState>() != null) {
                        context.findAncestorStateOfType<_DriverHomeState>()!._onItemTapped(2);
                      }
                    },
                    child: const Text('View All'),
                  ),
